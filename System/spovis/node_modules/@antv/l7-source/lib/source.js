...
var Source = function (_EventEmitter) {
  ...
  function Source(data, cfg) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Source).call(this));
    _this.data = void 0;
    _this.extent = void 0;
    _this.hooks = {
      init: new _tapable.SyncHook(['source']),
      layout: new _tapable.SyncHook(['source']),
      update: new _tapable.SyncHook(['source'])
    };
    _this.parser = {
      type: 'geojson'
    };
    ...
    _this.rawData = (0, _cloneDeep2.default)(data);
  ...
  (0, _createClass2.default)(Source, [{
    ...
    value: function setData(data) {
      this.rawData = data;
      this.originData = (0, _cloneDeep2.default)(data);
      this.init();
      this.emit('update');
    }
  }, {
    ...
    value: function getFeatureById(id) {
      ...
      if (type === 'geojson' && !this.cluster && this.transforms.length === 0) {
        return id < this.originData.features.length ? this.originData.features[id] : 'null';
      } else {
