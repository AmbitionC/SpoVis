...
var DataMappingPlugin = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_l7Core.TYPES.IGlobalConfigService), _dec3 = (0, _inversify.inject)(_l7Core.TYPES.ILogService), _dec(_class = (_class2 = (_temp = function () {
  ...
  (0, _createClass2.default)(DataMappingPlugin, [{
    ...
    value: function apply(layer, _ref) {
      ...
      layer.hooks.beforeRenderData.tap('DataMappingPlugin', function (flag) {
        if (flag || layer.dataState.dataMappingNeedUpdate || layer.layerModelNeedUpdate) {
      ...
      layer.hooks.beforeRender.tap('DataMappingPlugin', function () {
        ...
        if ((filter === null || filter === void 0 ? void 0 : filter.needRemapping) && (filter === null || filter === void 0 ? void 0 : filter.scale)) {
        ...
        if (attributesToRemapping.length) {
          if (filter === null || filter === void 0 ? void 0 : filter.needRemapping) {
    ...
    value: function mapping(attributes, data, predata) {
      ...
      return data.map(function (record, i) {
