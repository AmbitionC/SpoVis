...
var _mergeJsonSchemas = _interopRequireDefault(require("merge-json-schemas"));

var _tapable = require("tapable");

var _MultiPassRendererPlugin = require("../plugins/MultiPassRendererPlugin");
...
var BaseLayer = (_dec = (0, _l7Core.lazyInject)(_l7Core.TYPES.ILogService), _dec2 = (0, _l7Core.lazyInject)(_l7Core.TYPES.IGlobalConfigService), _dec3 = (0, _l7Core.lazyInject)(_l7Core.TYPES.IShaderModuleService), (_class = (_temp = function (_EventEmitter) {
  ...
  function BaseLayer() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(BaseLayer).call(this));
    ...
    _this.hooks = {
      init: new _tapable.SyncBailHook(),
      afterInit: new _tapable.SyncBailHook(),
      beforeRender: new _tapable.SyncBailHook(),
      beforeRenderData: new _tapable.SyncWaterfallHook(['data']),
      afterRender: new _tapable.SyncHook(),
      beforePickingEncode: new _tapable.SyncHook(),
      afterPickingEncode: new _tapable.SyncHook(),
      beforeHighlight: new _tapable.SyncHook(['pickedColor']),
      afterHighlight: new _tapable.SyncHook(),
      beforeSelect: new _tapable.SyncHook(['pickedColor']),
      afterSelect: new _tapable.SyncHook(),
      beforeDestroy: new _tapable.SyncHook(),
      afterDestroy: new _tapable.SyncHook()
    };
    _this.models = [];
  ...
  (0, _createClass2.default)(BaseLayer, [{
    ...
    value: function setActive(id, options) {
      ...
      if ((0, _isObject2.default)(id)) {
        ...
        this.hooks.beforeSelect.callAsync((0, _l7Utils.encodePickingColor)(id), function () {
          setTimeout(function () {
            _this5.reRender();
          }, 1);
        });
    ...
    value: function getMinZoom() {
      var _this$getLayerConfig5 = this.getLayerConfig(),
          minZoom = _this$getLayerConfig5.minZoom;
    ...
    value: function getMaxZoom() {
      var _this$getLayerConfig6 = this.getLayerConfig(),
          maxZoom = _this$getLayerConfig6.maxZoom;
    ...
    value: function getConfigSchemaForValidation() {
      if (!this.configSchema) {
        this.configSchema = (0, _mergeJsonSchemas.default)([_schema.default, this.getConfigSchema()]);
      }
    ...
    key: "needPick",
    value: function needPick() {
      var _this$getLayerConfig7 = this.getLayerConfig(),
          _this$getLayerConfig8 = _this$getLayerConfig7.enableHighlight,
          enableHighlight = _this$getLayerConfig8 === void 0 ? true : _this$getLayerConfig8,
          _this$getLayerConfig9 = _this$getLayerConfig7.enableSelect,
          enableSelect = _this$getLayerConfig9 === void 0 ? true : _this$getLayerConfig9;

      var eventNames = this.eventNames().filter(function (name) {
  ...
  writable: true,
  initializer: null
}), _descriptor2 = (0, _applyDecoratedDescriptor2.default)(_class.prototype, "configService", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor3 = (0, _applyDecoratedDescriptor2.default)(_class.prototype, "shaderModuleService", [_dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
