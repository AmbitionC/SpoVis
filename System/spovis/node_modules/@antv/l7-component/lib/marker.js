...
var _anchor = require("./utils/anchor");
...
var Marker = function (_EventEmitter) {
  ...
  function Marker(option) {
    ...
    _this.markerOption = void 0;
    _this.defaultMarker = void 0;
    _this.popup = void 0;
    ...
    _this.markerOption = _objectSpread({}, _this.getDefault(), {}, option);
  ...
  (0, _createClass2.default)(Marker, [{
    ...
    value: function getDefault() {
      return {
        element: undefined,
        anchor: _anchor.anchorType.BOTTOM,
        offsets: [0, 0],
        color: '#5B8FF9',
        draggable: false
      };
    ...
    value: function update() {
      ...
      _l7Utils.DOM.setTransform(element, "".concat(_anchor.anchorTranslate[anchor]));
    }
  }, {
    key: "onMapClick",
    ...
    value: function init() {
      ...
      (0, _anchor.applyAnchorClass)(element, anchor, 'marker');
    }
  }, {
