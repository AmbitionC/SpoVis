...
import { IAnimateOption, IEncodeFeature, IScale, IScaleOptions, IStyleAttributeService, StyleAttrField, StyleAttributeOption, Triangulation } from './IStyleAttributeService';
