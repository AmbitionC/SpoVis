...
var PixelPickingPass = (_dec = injectable(), _dec2 = inject(TYPES.ILogService), _dec(_class = (_class2 = (_temp = function (_BaseNormalPass) {
  ...
  function PixelPickingPass() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(PixelPickingPass)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _this.pickFromPickingFBO = function (_ref) {
      ...
      if (!_this.layer.isVisible() || !_this.layer.needPick()) {
        return;
      }
      ...
      useFramebuffer(_this.pickingFBO, function () {
        ...
        if (pickedColors[0] !== 0 || pickedColors[1] !== 0 || pickedColors[2] !== 0) {
          ...
          _this.triggerHoverOnLayer(_objectSpread({}, _target, {
            type: 'unpick'
          }));
...
}(BaseNormalPass), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "logger", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
})), _class2)) || _class);
export { PixelPickingPass as default };
