        ...
        var _loop = function _loop(vertexIdx) {
          descriptors.forEach(function (descriptor, attributeIdx) {
            if (descriptor && descriptor.update) {
              ...
              (_ref2 = descriptor.buffer.data).push.apply(_ref2, (0, _toConsumableArray2.default)(descriptor.update(feature, featureIdx, verticesForCurrentFeature.slice(vertexIdx * vertexSize, vertexIdx * vertexSize + vertexSize), vertexIdx, normal)));
            }
          });
        };
