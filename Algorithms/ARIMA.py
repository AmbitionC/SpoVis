...
def main():
  ...
  # 原始曲线
  plot_figure('Facilities Growth Curve', 'Year', 'Number', dataSet['Year'], dataSet['Instrument'])

  # 自相关曲线
  plot_acf_figure(instrument_set, 'Facilities ACF Figure')

  # 平稳性检测
  # caculate_ADF(instrument_set)

  # 差分数据
  diff_data = caculate_diff(instrument_set, 'Facilities Diff Figure')

  # 差分数据的自相关曲线
  plot_acf_figure(diff_data, 'Facilities Diff ACF Figure')

  # 差分数据的偏自相关图
  plot_pacf_figure(diff_data, 'Facilities Diff PACF Figure')
